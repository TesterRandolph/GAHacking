(function() {
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
        ...
        Jc = function(a, b) {
            ...
            c = a.get(cc);
            if (e = (c = M.location[c ? "href" : "search"].match("(?:&|#|\\?)" + K("_ga")
                    .replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1") + "=([^&#]*)")) && 2 == c.length ? c[1] : "") a.get(bc) ? (c = e.indexOf("."), -1 == c ? J(22) : (d = e.substring(c + 1), "1" != e.substring(0, c) ? J(22) : (c = d.indexOf("."), -1 == c ? J(22) : (e =
                d.substring(0, c), c = d.substring(c + 1), e != Ic(c, 0) && e != Ic(c, -1) && e != Ic(c, -2) ? J(23) : (J(11), a.data.set(Q, c)))))) : J(21);
            b && (J(9), a.data.set(Q, K(b)));
            a.get(Q) || ((c = (c = O.gaGlobal && O.gaGlobal.vid) && -1 != c.search(/^(?:utma\.)?\d+\.\d+$/) ? c : void 0) ? (J(17), a.data.set(Q, c)) : (J(8), a.data.set(Q, [fe() ^ Mc() & 2147483647, Math.round((new Date)
                .getTime() / 1E3)].join("."))));
            mc(a)
        },
        Kc = function(a) {
